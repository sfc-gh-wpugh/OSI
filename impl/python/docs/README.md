...
| Doc | What it covers |
|:---|:---|
| [`ALGEBRA_LAWS.md`](ALGEBRA_LAWS.md) | The companion to [`JOIN_ALGEBRA.md`](JOIN_ALGEBRA.md): concrete Hypothesis strategies, property tests, and mutation-testing targets that enforce each algebra law. |
